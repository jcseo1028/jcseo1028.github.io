...
- 2026.08 : 운동 비율 85% ↑ (2026.07:67.7%) | 흡연 비율 50% ↓ (2026.07:52.7%)
- 2026.07 : 운동 비율 85% ↑ (2026.06:86.7%) | 흡연 비율 50% ↓ (2026.06:51.8%)
- 2026.06 : 운동 비율 85% ↑ (2026.05:90.3%) | 흡연 비율 50% ↓ (2026.05:53.5%)
- 2026.05 : 운동 비율 85% ↑ (2026.04:64.5%) | 흡연 비율 50% ↓ (2026.04:55.8%)
- 2026.04 : 운동 비율 85% ↑ (2026.03:19.4%) | 흡연 비율 50% ↓ (2026.03:59.0%)
- 2026.03 : 운동 비율 85% ↑ (2026.02:14.3%) | 흡연 비율  0%   (2026.02:54.8%)
- 2026.02 : 운동 비율 85% ↑ (2026.01:54.8%) | 흡연 비율  0%   (2026.01:54.8%)
- 2026.01 : 운동 비율 85% ↑ (2025.12:22.6%) | 흡연 비율  0%   (2025.12:49.7%)
- 2025.12 : 운동 비율 85% ↑ (2025.11:66.7%) | 흡연 비율  0%   (2025.11:48.2%)
...
- 원하는 일을 하기 전에 해야할 일을 먼저 하자.(Have to do > Want to do)
- 진짜 하기 싫은 일이라도 딱 10분만 해보자.
- 할까? 말까? 고민할 때에는 하는 것이 답이다.
...
======================
[작업인원]  [퇴근시간]  [근무지]
  서진철       16:30      사내 시차출근제 신청(07:30~16:30)

[금일 진행 사항]

■ 3D Safety Scanner 개발 관련

- Review 진행
  - ROS 적용 보다 현재 버전 기준으로 실환경 테스트 먼저 진행.
  
[타겟일정]

■ 3D Safety Scanner 개발 관련

- 06/20 ~ 08/21 : 3D Safety Scanner 구현 및 테스트
- 07/06 ~ 07/31 : 3D Region Editor 구현 및 테스트
- 07/06 ~ 08/07 : Laser Scanner 구현 및 테스트
- 08/10 ~ 09/25 : AMR 연동 패키지 개발 및 테스트

[특이사항]

■ 3D Safety Scanner 개발 관련

- Project : JP4-26-E008 (AMR 용 Depth Camera 기반 3D Safety Scanner 개발)

==============================================================================================================

■ 3D Depth Camera 내재화 관련

- LiDAR 보조용 관련 검토는 승일이가 진행 예정.
  - YOLO + Segmentation + Depth -> 이건 추후 과제로 더이상 진행하지 않음.

- Depth Camera 테스트 한 것들 정리 필요함.
  - 사물인식은 현재 버전으로 일단 정리 완료.

- 다래 것을 확인해봤을 때, 중요한 것은 SW다?(진욱T)
  - 서버에서 학습한다?
  - 도면 학습 관련...

- 사물 인식 관련
  - 난반사 관련 다른 센서 검토 필요. -> 구조광, Swing Line 관련 검토 진행했으나, 반사에는 장사 없는 듯함.

- Pallet Align 정합성 확인 완료
  - 4월경 연동 테스트 진행 예정.
  - 우선은 홀딩, 모델 관리 방안 검토 필요함.
- AMR 제어 프로그램과 설정 파라미터 정리 필요함.
  - 기존 파라미터 확인. -> 현재 알고리즘으로 정리하자.

■ Local Coding Agent 관련

- 프로젝트 전체 구조 분석 관련 기능 추가 진행 중.
- 소스코드 흐름 분석 관련 기능 추가 진행 중.
- VSIX 확장 UI 수정 진행 중.
...
- 공수입력용 주요 프로젝트 목록
  - JP4-26-E008 (비전기술팀 연구개발 2026 AMR 용 Depth Camera 기반 3D Safety Scanner 개발)
  - JP6-25-E002 (홍보/연구용 AMR 제작) - 완료.
  - JP4-25-E022 (비전기술팀 연구개발 2025 Smart Camera Platform 개발) - 완료.
  - JP4-25-E023 (비전기술팀 연구개발 2025 Smart Labeling App 개발) - 완료.
  - JP4-25-N024 (LG에너지 솔루션 40ppm 미국 랜싱 각형 용접 장비 (검토))
  - JP5-24-E013 (비전기술팀 연구 개발 (2024) Stacking) - 완료.
  ...
  - JP4-24-E002 (비전기술팀 연구개발 건 (2024년도)) -- 사용 금지
...
- [Github 저장소로 업데이트](https://github.com/jcseo1028/init-project-with-copilot-agent)
- [초기저장소 Bootstrap 프롬프트](https://chatgpt.com/s/t_69d1c509b44c8191831a1cbdf0e52bf3)
- [이미 진행된 프로젝트를 분석해서 진행하는 Bootstrap 프롬프트](https://chatgpt.com/s/t_69d1c7305b0c81919ac014631bcace79)
...
- [잃어버린 기본기를 찾아서](https://news.hada.io/weekly/202617)
- [Agentic Engineering 9 Skills](https://flowkater.io/posts/2026-03-01-agentic-engineering-9-skills/)
...
- [캐리어 바퀴 수리](https://smartstore.naver.com/100points)
