...
- SDV, UT iPAD 신작 관련
  ...
  - CRD AI 적용 검토
    ...
    - 출장 일정 (6/9 ~ 6/18) 출장 완료.
    - [x] 출장 완료 보고서 작성
    - [x] 출장 경비 전표 상신.
    - Blank NG 시 AI 적용 검토.
      - [x] 총 5포인트 입력 필요함.
      - [x] 검사 중 NG 발생 시 NG 처리 후 다음 진행 필요함.
      - [ ] 시뮬레이션 확인 후 실행파일 고객사 전달 필요함.
  - CRD 프로그램 정리
    - 추가 개선 사항 검토 필요.
...
- CSOT, Tray Vision 관련
  ...
  - [ ] 피커 위치 변경 후, 회전 중심 관련 정보 업데이트되어 있는 지 확인 필요.(나찌랑 확인 필요함.) -> 이건 끝났나?
