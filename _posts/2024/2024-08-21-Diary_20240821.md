...
- 고객사 미팅 참석
  - 개구부 측정 관련 반복성 데이터 제출 요청 ( ~ 08/23 )
  - 08/28(수) 고객사 미팅 시 논의할 자료 요청 / 2.5D vs 3D 비교 자료 ( ~08/26)
  - 기존 검사 프로그램 이미지 반출 완료.

[타겟일정]
■ FINEDNC, 압출캔 용접 라인

- ~ 08/23(금) : Linescan, Areascan Camera DLL 보완 완료 및 Lab. Test 진행 완료.
