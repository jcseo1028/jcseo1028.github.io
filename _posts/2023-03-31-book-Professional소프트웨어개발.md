...
213p.
소프트웨어 전문성 개발 단계 레벨 요구사항

#### chapter 17 공학

242p.
재사용 가능한 프로젝트 산출물 리스트

#### chapter 18 배움의 길

자격증이 필요하지는 않지만 자격을 확인할 수 있는 무언가는 있어야 할 거 같다.

#### chapter 19 배지

272p.
예전에 기술고시를 준비하려고도 했었던 거 같은데...
