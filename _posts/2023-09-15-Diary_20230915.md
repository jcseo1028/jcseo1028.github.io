...
- SDV, UT iPAD 신작 관련
  ...
  - 출장 준비
  - [ ] 연차 신청 - 09/13 ~ 09/15 - 시발 그룹장 결제??
  - [x] 출장 명령서 - 본부장(동전무) - 법인 카드(V)
  - [x] 버스 예약 - 09/18 04:50, 인천공항 T1 - 법인 카드로 재결제??
  - [ ] 숙소는 어디로 - 하모니?
...
핵심을 놓치지 말자. 안주하지 말고, 끝까지 해보자.

모아 놓은 것은 쓰레기고 모이는 것은 데이터다.

훌륭한 병사가 되기 보다는 지휘관이 되어야 한다. ( 혼자 다 할 수는 없다. ) - 정체성 변경 필요.
